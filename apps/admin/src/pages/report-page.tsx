...
export default function ReportPage({ pic, username, title, filterContent, onReset, columns, tableData, children }: ReportPageProps) {
...
const btnWhite: React.CSSProperties  = { background: 'white', border: '2px solid #ccc', borderRadius: '20px', padding: '8px 24px', fontSize: '15px', cursor: 'pointer' }
const btnOrange: React.CSSProperties = { background: '#e85d00', color: 'white', border: 'none', borderRadius: '20px', padding: '8px 24px', fontSize: '15px', cursor: 'pointer' }