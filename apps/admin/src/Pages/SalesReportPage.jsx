...
import FilterPanel from "../saleReport/FilterPanel.jsx";
import SalesTable from "../saleReport/SalesTable.jsx";
import ResultPanel from "../saleReport/ResultPanel.jsx";

async function fetchSalesData({ product, dateFrom, dateTo, status }) {
  // TODO: แทนที่ block นี้ด้วย:
  //   const params = new URLSearchParams({ product, from: dateFrom, to: dateTo, status });
...
function SalesReportPage({ pic, username, onSave }) {
      ...
      <main className="main" style={{marginBottom:'24px'}}>
        ...
        <header className="page-header" style={{ color: "white" }}>
          <div>
            ...
            {/* <h1 className="page-title"  style={{ marginBottom: 0 }}>Sales Performance</h1> */}
