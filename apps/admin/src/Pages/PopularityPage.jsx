...
//กูsortไม่เป็น
const sortKey = { 'Genre': 'genre', 'Views': 'views', 'Total Purchase': 'purchase' }[sortBy]
        ...
        >
            ...
            <div style={{ background: 'white', borderRadius: '8px', padding: '16px', marginTop: '24px' }}>
                ...
                <div style={{ display: 'flex', gap: '16px', marginTop: '12px', fontSize: '12px' }}>
                    {[['#4472C4','Action'],['#ED7D31','Drama'],['#70AD47','Fantasy'],['#FF4444','Sci-Fi']].map(([c, name]) => (
                        <span key={name}>
...
const label = { fontWeight: '700', marginBottom: '6px' }
const sel   = { padding: '10px 14px', borderRadius: '8px', border: 'none', minWidth: '180px', fontSize: '14px' }
const inp   = { padding: '10px', borderRadius: '8px', border: 'none', fontSize: '14px' }